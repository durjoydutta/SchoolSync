    ...
    return (
        <div className="relative grid min-h-svh md:grid-cols-2">
            ...
            <div className="relative hidden bg-muted md:block">
                <img
                    src="https://images.pexels.com/photos/5445607/pexels-photo-5445607.jpeg"
                    alt="Image"
                    className="absolute inset-0 h-full w-full object-cover dark:brightness-[0.2] grayscale-[30%] dark:grayscale-[95%]"
                />
                <motion.div 
