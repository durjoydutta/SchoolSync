...
<div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          {/* USER INFO CARD */}
          <div className="bg-lamaSky dark:bg-cyan-800 py-6 px-4 rounded-md flex-1 flex gap-4">
            <div className="w-1/3">
              <Image
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            {/* CARD */}
            <div className="bg-white dark:bg-stone-800 p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              <Image
        ...
        {/* BOTTOM */}
        <div className="mt-4 bg-white dark:bg-stone-800 rounded-md p-4 h-[800px]">
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white dark:bg-stone-800 p-4 rounded-md">
